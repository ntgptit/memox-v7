...
|---|---|---|---|
| colorScheme.outlineVariant | `lib/core/theme/app_border_colors.dart:46` — Color(0xFFD2D2DD) | `#D2D2DD` | `#D2D2DD` |
| no token within ΔE-ish range — needs a new one | `lib/core/theme/app_border_colors.dart:50` — Color(0xFF4C487A) | `#4C487A` | `#4C487A` |
| no token within ΔE-ish range — needs a new one | `lib/core/theme/app_border_colors.dart:100` — Color(0xFFE9ECF5) | `#E9ECF5` | `#E9ECF5` |
| no token within ΔE-ish range — needs a new one | `lib/core/theme/app_border_colors.dart:107` — Color(0xFF2E2A54) | `#2E2A54` | `#2E2A54` |
| no token within ΔE-ish range — needs a new one | `lib/core/theme/app_border_colors.dart:109` — Color(0xFF6E6ECE) | `#6E6ECE` | `#6E6ECE` |
| no token within ΔE-ish range — needs a new one | `lib/core/theme/app_border_colors.dart:112` — Color(0xFF7C79C8) | `#7C79C8` | `#7C79C8` |
| no token within ΔE-ish range — needs a new one | `lib/core/theme/app_border_colors.dart:124` — Color(0xFFB6B6E2) | `#B6B6E2` | `#B6B6E2` |
| no token within ΔE-ish range — needs a new one | `lib/core/theme/app_border_colors.dart:139` — Color(0xFF6560B8) | `#6560B8` | `#6560B8` |
| no token within ΔE-ish range — needs a new one | `lib/core/theme/app_border_colors.dart:166` — Color(0xFF8887CE) | `#8887CE` | `#8887CE` |
| no token within ΔE-ish range — needs a new one | `lib/core/theme/app_border_colors.dart:171` — Color(0xFF5D65B2) | `#5D65B2` | `#5D65B2` |
| no token within ΔE-ish range — needs a new one | `lib/core/theme/app_border_colors.dart:226` — Color(0xFF6E6A98) | `#6E6A98` | `#6E6A98` |
...
| no token within ΔE-ish range — needs a new one | `lib/core/theme/app_surface_colors.dart:49` — Color(0xFFF1F1FC) | `#F1F1FC` | `#F1F1FC` |
| no token within ΔE-ish range — needs a new one | `lib/core/theme/app_surface_colors.dart:56` — Color(0xFF332F58) | `#332F58` | `#332F58` |
| no token within ΔE-ish range — needs a new one | `lib/core/theme/app_surface_colors.dart:70` — Color(0xFFEAEBFD) | `#EAEBFD` | `#EAEBFD` |
...
| colorScheme.outline | `lib/core/theme/app_border_colors.dart:195` — Color(0xFF8A8A92) | `#8A8A92` | `#8A8A92` |
