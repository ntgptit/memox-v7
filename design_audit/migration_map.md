...
|---|---|---|---|
| colorScheme.outlineVariant | `lib/core/theme/foundations/app_border_colors.dart:20` — Color(0xFFC5CBE3) | `#C5CBE3` | `#C5CBE3` |
| no token within ΔE-ish range — needs a new one | `lib/core/theme/foundations/app_border_colors.dart:21` — Color(0xFF2A3267) | `#2A3267` | `#2A3267` |
| no token within ΔE-ish range — needs a new one | `lib/core/theme/foundations/app_border_colors.dart:26` — Color(0xFF5A6BAE) | `#5A6BAE` | `#5A6BAE` |
| no token within ΔE-ish range — needs a new one | `lib/core/theme/foundations/app_border_colors.dart:41` — Color(0xFFBDC4FB) | `#BDC4FB` | `#BDC4FB` |
| no token within ΔE-ish range — needs a new one | `lib/core/theme/foundations/app_border_colors.dart:42` — Color(0xFF414B85) | `#414B85` | `#414B85` |
| colorScheme.outline | `lib/core/theme/foundations/app_border_colors.dart:25` — Color(0xFF7C85AB) | `#7C85AB` | `#7C85AB` |
| colorScheme.surface | `lib/core/theme/foundations/app_surface_colors.dart:18` — Color(0xFFF7F9FE) | `#F7F9FE` | `#F7F9FE` |
| colorScheme.scrim | `lib/core/theme/foundations/app_surface_colors.dart:19` — Color(0xFF0A0E27) | `#0A0E27` | `#0A0E27` |
