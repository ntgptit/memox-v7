...
| V3 | 8 | literal duplicating an existing token |
...
|---|---|---|---|---|---|---|
| V3 | 🟡 | `lib/core/theme/foundations/app_border_colors.dart:20` | Color(0xFFC5CBE3) | `#C5CBE3` | `#C5CBE3` | colorScheme.outlineVariant |
| V3 | 🟡 | `lib/core/theme/foundations/app_border_colors.dart:21` | Color(0xFF2A3267) | `#2A3267` | `#2A3267` | no token within ΔE-ish range — needs a new one |
| V3 | 🟡 | `lib/core/theme/foundations/app_border_colors.dart:25` | Color(0xFF7C85AB) | `#7C85AB` | `#7C85AB` | colorScheme.outline |
| V3 | 🟡 | `lib/core/theme/foundations/app_border_colors.dart:26` | Color(0xFF5A6BAE) | `#5A6BAE` | `#5A6BAE` | no token within ΔE-ish range — needs a new one |
| V3 | 🟡 | `lib/core/theme/foundations/app_border_colors.dart:41` | Color(0xFFBDC4FB) | `#BDC4FB` | `#BDC4FB` | no token within ΔE-ish range — needs a new one |
| V3 | 🟡 | `lib/core/theme/foundations/app_border_colors.dart:42` | Color(0xFF414B85) | `#414B85` | `#414B85` | no token within ΔE-ish range — needs a new one |
| V3 | 🟡 | `lib/core/theme/foundations/app_surface_colors.dart:18` | Color(0xFFF7F9FE) | `#F7F9FE` | `#F7F9FE` | colorScheme.surface |
| V3 | 🟡 | `lib/core/theme/foundations/app_surface_colors.dart:19` | Color(0xFF0A0E27) | `#0A0E27` | `#0A0E27` | colorScheme.scrim |
...
- **V3** `Color(0xFFBDC4FB)` — A colour literal outside the palette file. It renders the same value in both modes, so it is also a latent V6: #BDC4FB.

- **V3** `Color(0xFF414B85)` — A colour literal outside the palette file. It renders the same value in both modes, so it is also a latent V6: #414B85.
