...
/// outcomes (BR-220): re-waking the app to re-discover the same emptiness buys
...
Future<bool> runDailyReminderTask() async {
  ...
  try {
    ...
    try {
      ...
      // **No anchor is passed here.** BR-221's day skip is derived inside the
...
///
/// **No count, no deck name, no copy** (BR-222). The outcome enum is the whole
