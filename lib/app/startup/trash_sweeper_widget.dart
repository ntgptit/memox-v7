...
/// Runs the retention sweep at startup and on every resume (BR-190).
///
/// **Two of BR-190's three triggers live here; the third is the Trash list
...
/// tries again. The log carries ids only — never card content (BR-193).
