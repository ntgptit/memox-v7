...
SnackBarThemeData buildSnackBarTheme(
  ...
  // **The action is text, so it takes the snack bar's ink** (GC-3,
  // 2026-09-17), not the SDK's own `inversePrimary` default: the slate ground
  // does not flip between modes, and neither does the ink.
