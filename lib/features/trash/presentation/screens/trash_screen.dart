...
/// `initState` would be a rule nothing can find (BR-190).
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MxContentShell(
      ...
      leading: selection.isActive
          ...
          : null,
      actions: <Widget>[
        // **Selection needs a visible way in** (wireframe W2, BR-192). Without
        // it, multi-select — half of UC-12 A2 — is reachable only by long
...
/// Turns selection on by taking the first visible row (BR-192).
///
...
class _TrashBody extends ConsumerWidget {
  ...
  /// Restores a whole selection into **one** target (BR-192).
  ///
