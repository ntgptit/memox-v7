...
/// The Trash list, swept before it is shown (UC-21 step 3, BR-264).
///
/// **The sweep runs here rather than in the screen**, because "opening Trash"
/// is one of the three moments BR-264 names and a widget's `initState` is not a
...
/// Where one batch may go back to (BR-261).
///
...
/// The rows the user has pointed at (BR-266).
///
...
/// Restoring one batch into a chosen target (BR-261, BR-262).
///
...
/// Reversing the deletion just made (BR-263).
///
...
/// Deleting the chosen batches for good (BR-265, BR-266).
///
