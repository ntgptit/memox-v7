...
class TrashFilterBarWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      // supplies the screen gutter, and adding `AppSpacing.lg` on top of it put
      // the first chip 16dp further in than every row below — G1 asks for one
      // left edge, and two paddings can only ever produce two.
      //
