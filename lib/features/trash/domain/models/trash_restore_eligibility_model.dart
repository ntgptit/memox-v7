...
/// Where a deleted sub-deck may be restored to (BR-187).
///
/// **The rule is `deckMoveRejection`, unchanged.** BR-187 says restore uses the
...
/// the single most likely thing the user wants (BR-188 only forbids choosing it
/// *for* them).
List<TrashDeckCandidate> buildTrashDeckCandidates({
  ...
  // (BR-187); `TrashTopLevelTarget` is the whole answer there.
