...
/// One segment of the path an item was deleted from (BR-267).
///
/// **Information, never a destination.** The path is where the item *was*; where
/// it goes back to is whatever target the user picks (BR-261). The two are
...
/// One deletion, as Trash shows it (BR-256, UC-21).
///
...
final class TrashBatchEntity {
  ...
  /// The deck's name, or the card's front. Displayed, never logged (BR-267).
  ...
  /// How many decks and cards this batch would bring back (BR-262).
  ///
  /// A descendant already in Trash under an older batch is in neither count —
  /// restoring this batch leaves it where it is (BR-258), and the confirm
