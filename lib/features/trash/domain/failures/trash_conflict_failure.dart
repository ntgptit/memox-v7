...
/// `DeckMoveRejection`, thrown unchanged, because BR-187 says restore uses the
...
enum TrashConflictReason {
  ...
  /// level (BR-187). A root has no parent, and nothing else may become one.
  targetLevelMismatch,

  /// Undo was pressed after the original location stopped qualifying — deleted,
  /// turned into a card deck, or now at the depth limit (BR-189, UC-12 E3).
  ///
  ...
  /// into rows that are still active (BR-191, UC-12 E4).
