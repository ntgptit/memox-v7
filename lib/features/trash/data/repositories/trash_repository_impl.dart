...
final class TrashRepositoryImpl
  ...
  Stream<List<TrashRestoreTarget>> watchRestoreTargets(String batchId) async* {
    ...
    // list rather than an error the picker cannot act on (UC-21 E6).
  ...
  /// Where a deleted card may go back to (BR-165, BR-261).
  ///
  ...
  /// Where a deleted deck may go back to (BR-261).
  ///
