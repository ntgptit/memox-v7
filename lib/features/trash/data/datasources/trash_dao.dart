...
final class TrashDao {
  ...
  /// no such deck — the origin is a perfectly good destination (BR-188 only
  ...
  /// [allowedBatchIds] (BR-191). Zero means the purge is safe.
  ...
  /// Rewrites `root_deck_id` for a whole subtree, tombstones included (BR-188).
