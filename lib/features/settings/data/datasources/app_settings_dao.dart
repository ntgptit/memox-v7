...
/// Data access for the single `app_settings` row (BR-182).
///
...
final class AppSettingsDao {
  ...
  ///
  /// Each group is one transaction (BR-188). A single-statement update is
  ...
  /// The row, re-emitted on every write to `app_settings` (BR-182).
  ///
