...
/// Changes the app-wide study defaults (BR-211).
///
...
/// — this one and the deck's own options — would be free to disagree (BR-211).
///
...
/// different surface (BR-212).
///
/// **Sessions already running are untouched** (BR-213). A session fixes its
