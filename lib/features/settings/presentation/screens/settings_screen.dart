...
/// The app's global options (UC-16).
///
...
///
/// **One read for the whole screen** (AD-13, BR-210). Four values, one row, one
...
/// saving and carries only its own failure (BR-216, wireframe S7, S8).
