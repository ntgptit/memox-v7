...
///
/// **A failed save keeps the draft** (BR-188). The text field is not rebuilt
      ...
      child: MxCard(
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: AppSpacing.lg),
            // BR-185 in one line. Without it the change reads as one that did
