...
/// `app_chip_theme.dart` and to the web kit that mirrors it — see the M99.23
...
/// shrinks the text.
///
/// **[selected] is the persisted value, never a pending one** (BR-188).
class SettingsChoiceRowsWidget<T extends Enum> extends StatelessWidget {
  ...
  /// While true the whole group is locked and says so (BR-188, W3 state 4).
