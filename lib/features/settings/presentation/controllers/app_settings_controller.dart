...
/// The app's global options, live (BR-210).
///
...
///
/// **A stream, not a future.** BR-210 requires one write to update every open
/// surface, and BR-214/BR-215 require the theme to change under a screen that
