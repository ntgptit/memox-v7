...
/// The two study defaults (BR-211), saved together behind one button.
///
/// **One of four controllers in this file, not one controller with four
/// methods.** Each group writes atomically on its own — BR-216 — and carries
...
/// The theme choice (BR-214). Written on selection, not behind a button.
@riverpod
...
/// The language choice (BR-215). Same shape as the theme, same reasons.
@riverpod
