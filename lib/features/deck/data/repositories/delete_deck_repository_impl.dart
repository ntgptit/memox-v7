...
/// back (BR-182, BR-184, BR-185, BR-186). The move operation next door has
...
mixin _DeleteDeckOperation implements DeckRepository {
  ...
  /// its content type back if that was its last child (BR-182, BR-186).
  ///
  ...
  /// and their tags until the batch is purged (BR-185). What the user
  /// experiences is unchanged — the subtree leaves every active surface in the
  /// same instant (BR-183) — and what they gain is thirty days to change their
  /// mind.
  ///
  ...
  Future<void> deleteDeck(String deckId) => _guard(
    () => _dao.runInTransaction(() async {
      ...
      // it inside this transaction (BR-182, BR-184, BR-185).
