...
/// Reports that a deck went to Trash, and offers to take it back (BR-182,
/// BR-189).
///
...
void showDeckMovedToTrash(
  ...
  showMxUndoSnackBar(
    ...
    // **The reason travels, and it has to** (UC-12 E3). "That couldn't be
...
/// The sentence for a refused Undo (UC-12 E3).
///
