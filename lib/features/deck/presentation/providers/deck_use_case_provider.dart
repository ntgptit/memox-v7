...
import '../../domain/usecases/promote_sub_deck_to_root_use_case.dart';
...
@riverpod
PromoteSubDeckToRootUseCase promoteSubDeckToRootUseCase(Ref ref) =>
    PromoteSubDeckToRootUseCase(ref.watch(deckRepositoryProvider));
