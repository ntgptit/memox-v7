...
/// Turns the daily reminder on (UC-17, BR-218, BR-228).
///
...
/// and only here — BR-218's whole point is that nothing asks before the user
/// does. The write third. The schedule last.
///
/// **The write comes before the schedule, and a failed schedule undoes it.**
/// BR-228 says the setting stays off when enabling does not complete, and there
