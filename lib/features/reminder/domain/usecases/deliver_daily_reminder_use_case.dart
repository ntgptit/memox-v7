...
/// One fire-time evaluation (BR-220, BR-221, BR-222).
///
...
///
/// Returns an outcome rather than logging one: BR-222 keeps counts and deck
...
class DeliverDailyReminderUseCase {
  ...
  /// for tonight: two summaries in one local day, which BR-221 forbids.
  ///
  ...
  /// carries no count, no deck name and no copy (BR-222).
  ...
  /// Whether the local day [now] falls in has already had its summary (BR-221).
  ///
