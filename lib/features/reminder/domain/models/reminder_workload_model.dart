/// One root deck's share of the work a reminder may talk about (BR-224).
///
...
/// the ranking in BR-223 needs calendar days and this layer may not read a clock
...
final class ReminderWorkloadModel {
  ...
  /// The root deck's id — the last tie-break of BR-223's ordering.
  final String deckId;

  /// The root deck's name, which the notification MAY show (BR-222).
