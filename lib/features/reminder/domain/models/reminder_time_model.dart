...
/// BR-219's suggested time, 20:00 local, as a minute of the day.
const int kDefaultReminderMinute = 20 * 60;

/// A time of day the reminder may fire at, in **local** minutes (BR-219).
///
...
final class ReminderTime {
  ...
  /// BR-219's default, which needs no parsing.
