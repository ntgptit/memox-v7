...
/// Everything a daily reminder is allowed to say (BR-222).
///
...
/// nothing is due, which is BR-220's skip expressed as a value the caller has to
...
final class ReminderSummaryModel {
  ...
  /// Cards owed across every root deck, counted once each (BR-224).
  final int totalDueCount;

  /// The name of the most urgent root deck, by BR-223's ordering.
  ...
  /// database, no locale. The ranking in BR-223 is therefore a function that can
  ...
  /// BR-223's ordering, as a total order with no unresolved tie.
  ///
