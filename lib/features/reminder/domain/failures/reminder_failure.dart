...
enum ReminderSetupRejection {
  /// This build cannot deliver reminders here at all (BR-229).
  platformUnavailable,

  /// The OS refused the notification permission (BR-228).
  ///
  /// The setting stays off. Android grants one prompt per app, so the recovery
  /// is system settings, not another ask.
  permissionDenied,

  /// The OS accepted the request but the work could not be enqueued (BR-226).
  scheduleFailed,
  ...
  /// row and skips (BR-220) — but the user is owed the truth about it.
  cancelFailed,
