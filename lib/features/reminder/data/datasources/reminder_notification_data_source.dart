...
/// The one notification id the reminder ever uses (BR-221).
///
...
/// What a tapped reminder asks the app to open (BR-225).
///
...
final class ReminderNotificationDataSource {
  ...
  /// Whether this device will answer the plugin at all (BR-229).
  ///
  ...
  /// app may actually post (BR-228, BR-229).
  ///
  ...
  /// delivers nothing, which is exactly the phantom state BR-229 forbids.
  ///
  ...
  /// Posts the summary (BR-221, BR-222).
  ///
