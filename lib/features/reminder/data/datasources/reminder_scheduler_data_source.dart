...
/// The unique name of the pending run (BR-191).
///
...
/// `lib/app/reminder/`.
///
/// **Inexact by construction, which is the point** (BR-190). WorkManager
...
/// whole of BR-190's "reschedule if the platform needs it".
