...
final class ReminderDao {
  ...
  /// Writes the reminder choice, both columns together (BR-218, BR-219).
  ...
  /// Records when the last summary was posted (BR-221).
  Future<void> writeDelivered(DateTime deliveredAt) =>
      _db.markReminderDelivered(deliveredAt);

  /// The due workload per root deck, between [dayStart] and [now] (BR-224).
