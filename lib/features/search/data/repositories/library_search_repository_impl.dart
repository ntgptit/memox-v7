...
/// Global Library Search over the local database (UC-20).
///
...
/// path on screen with nothing to correct it (BR-254).
final class LibrarySearchRepositoryImpl implements LibrarySearchRepository {
  ...
  Stream<LibrarySearchPage> watchSearchPage({
    ...
    // BR-249. Not a shortcut for speed: an empty query must open **no**
  ...
  ///
  /// **Decks are walked to exhaustion before the first card appears** (BR-251).
