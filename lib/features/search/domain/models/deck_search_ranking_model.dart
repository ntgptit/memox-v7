...
final class SearchableDeck {
  ...
  /// is available, so no `lower()` is ever needed (BR-248).
...
/// Every deck whose name matches [query], ordered and cut to one page (BR-250,
/// BR-251, BR-253).
///
...
/// columns necessary in the first place (BR-248). The alternatives were adding a
/// column, which is a schema change BR-255 refuses without measurement, or
