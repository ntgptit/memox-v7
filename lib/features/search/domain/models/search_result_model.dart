...
/// The two groups a result can belong to, in the order they are shown (BR-186).
///
...
/// A deck whose name matched (BR-182).
...
/// A card whose front, back or one of whose tags matched (BR-182, BR-187).
