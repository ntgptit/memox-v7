...
/// How long the field must be quiet before the database is asked (BR-184).
///
...
///
/// **Clearing is immediate, typing waits** (BR-184). An empty query has nothing
...
/// One page of results, chained onto the page before it (BR-188).
///
...
Stream<LibrarySearchPage> librarySearchPage(Ref ref, int index) {
  ...
  // BR-184: nothing typed, nothing read. The use case guards this too — this
...
LibrarySearchState librarySearchResults(Ref ref) {
  ...
  // empty query cost nothing rather than cost a cancelled read (BR-184).
