...
/// Types into the catalog's search field (UC-12, BR-182). A free function for
...
/// The tag catalog (UC-12, wireframe M4.14).
///
/// **Library-level, not deck-level**, because a tag belongs to no deck (BR-93,
/// BR-182). It sits at `/tags` inside the Library branch, so the bottom bar
...
class _CatalogList extends StatelessWidget {
  ...
  /// Confirms what the write turned out to be (BR-186).
  ///
