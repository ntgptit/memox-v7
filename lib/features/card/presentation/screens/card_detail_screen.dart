...
/// Re-subscribes the content read after a failure (UC-12 E3).
///
...
/// One card, read-only, with its study history (UC-12, M4.14).
///
/// **Reading is what a tap now means** (BR-189). Before this screen existed a
...
///
/// **Nothing on this screen writes** (BR-182). There is no controller command
...
/// not studying it.
///
/// **Two reads, deliberately** (BR-187). Content, tags and the current schedule
...
class CardDetailScreen extends ConsumerWidget {
  ...
  /// Opens the editor **on top of** this screen (UC-12 A1).
  ///
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MxContentShell(
      ...
      actions: <Widget>[
        ...
        // would offer a repair that cannot work (M4.14 W3 faces 7 and 8).
        //
  ...
  /// other offers to read again (BR-188, UC-12 E1/E3).
  ///
...
/// The three bands in one scroll view (M4.14 V4, W2).
///
