...
/// Which tags the card list is narrowed to, **applied** (BR-183, BR-184).
///
...
/// describes nothing once the list is the 12 that carry one tag (BR-184).
