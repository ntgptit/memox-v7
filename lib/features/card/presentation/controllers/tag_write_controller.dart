...
/// Renaming one tag, which may turn out to be a merge (UC-12, BR-185, BR-186).
///
...
class TagRename extends _$TagRename {
  ...
  Future<void> submit(String rawName) async {
    ...
    try {
      ...
      // than from what the form guessed it would do (BR-186).
...
/// Deleting one tag from every card that carries it (UC-12 A3, BR-187).
///
