...
///
/// A tag deleted or merged away while the filter was on (BR-186, BR-187) leaves
...
/// Opens the multi-tag filter for one deck's card list (UC-12, M4.14 W6).
///
...
/// each time (BR-184) — N reads for one intention, with the list jumping behind
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        // and nothing else on the screen says so (BR-183, M4.14 W6 item 2).
        Text(
