...
/// Opens the rename form for one tag (UC-12, wireframe M4.14 W4).
///
...
class _RenameFormState extends ConsumerState<_RenameForm> {
  ...
  /// the folded name at the moment of the write (BR-186) — this cannot be that,
...
/// The merge disclosure (BR-186, M4.14 W4 item 3).
///
