...
/// The read side of one card, over Drift (UC-19).
///
/// **It holds a DAO with no write on it, and that is the enforcement of
/// BR-239.** Nothing in this file could mutate the database if it wanted to:
...
final class CardDetailRepositoryImpl implements CardDetailRepository {
  ...
  /// A missing row is the card being gone, not an empty result (BR-245).
  ///
