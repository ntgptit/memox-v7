...
/// Data access for the card detail surface (UC-12).
///
/// **Reads only, and there is no write method to leave out later.** BR-182 makes
...
final class CardDetailDao {
  ...
  /// The newest [limit] history rows of one card (BR-184).
