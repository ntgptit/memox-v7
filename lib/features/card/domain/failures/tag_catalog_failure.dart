...
/// What a rename actually did (BR-233, BR-234).
///
...
enum TagRenameOutcome {
  /// The folded name was free, so the tag kept its id and every link (BR-233).
...
enum TagCatalogProblem {
  ...
  /// overlay opened and the moment it submitted (UC-18 E3).
  tagMissing,
}
