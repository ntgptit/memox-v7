...
/// How many events one page of a card's history carries (BR-241).
///
...
/// One page of a card's history, and where the next one starts (BR-241).
///
...
class CardHistoryPageModel {
  ...
  /// all comes back as (BR-244), named so no caller has to build it by hand and
  ...
  /// Newest first: `answered_at DESC, id DESC` (BR-241).
