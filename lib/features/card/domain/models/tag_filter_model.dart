/// Which tags the card list is narrowed to (BR-183).
///
/// **A type rather than a bare `Set<String>`, and the reason is BR-183's
...
///
/// **The semantics between selected tags is OR** (BR-183): a card carrying any
...
final class TagFilter {
  ...
  /// Whether a tag predicate should be applied at all (BR-183).
