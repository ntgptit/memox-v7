...
/// One recorded turn as the card's history reads it (BR-242).
///
...
/// which rules it belonged to, and BR-243 groups on exactly that.
class CardHistoryEventModel {
  ...
  /// The generation this turn belongs to (BR-243).
  ...
  /// Where a page ending on this event resumes (BR-241).
  ///
