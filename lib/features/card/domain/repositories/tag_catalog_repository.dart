...
/// Contract for managing the tag catalog itself (UC-12, BR-182…BR-190).
///
...
/// prove by its own surface that it never writes a card row (BR-188).
///
...
abstract interface class TagCatalogRepository {
  ...
  /// **no card is touched** (BR-187, BR-188).
  ///
