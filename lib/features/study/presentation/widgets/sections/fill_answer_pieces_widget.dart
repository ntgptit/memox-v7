...
///
/// **Both slots are always built, and disabled is how a slot says no.** `fill`
/// used to drop the hint button once it was spent and the Check button once the
/// turn was graded, so the row re-centred twice per card and the primary action
/// moved under a finger already reaching for it.
