...
///
/// **Three loaded states, not one with holes in it** (BR-184). "No decks at
...
/// working rather than a locked door, the decks are still openable (BR-183), and
    ...
    return ListView(
      ...
      children: <Widget>[
        Text(
          ...
          // case — BR-182 needs four conditions at once, so no open session is
