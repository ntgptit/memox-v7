...
/// Picks the way a self-assess review will ask (BR-182).
///
...
/// is locked for the whole session (BR-186) — the one place in Study where a
...
class StudyDirectionChooserWidget extends StatefulWidget {
  ...
  ///
  /// Korean→Meaning, because that is what every review did before BR-182 — a
...
class _StudyDirectionChooserState extends State<StudyDirectionChooserWidget> {
  ...
  /// refusals reach this sheet (UC-12 E1 and E2) and only one of them is worth
