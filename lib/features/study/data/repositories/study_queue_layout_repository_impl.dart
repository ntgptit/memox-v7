...
mixin _StudyQueueLayoutOperations {
  ...
  ///
  /// [direction] is the session's choice (BR-203), and this is where BR-205
  ...
  /// structural rather than defensive: BR-203 makes the direction a property of
  ...
  List<StudyRecallDirection>? _directionsFor({
    ...
    // BR-205: `mixed` is assigned once, here, from the injected generator — the
