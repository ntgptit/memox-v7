...
| **Updated by task** | M5.26 (Study Home v1) — BR-182…BR-184: tab Study đọc thư viện thật (read-only, resume hợp lệ, xếp hạng workload, ba trạng thái đã tải) |
