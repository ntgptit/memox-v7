...
**Số 163 để trống có chủ đích.** Nó thuộc về task chuẩn hoá `content_type`
đang chạy song song ở một nhánh khác; M99.15 lấy 164 để hai nhánh không
cùng đặt tên một ID vĩnh viễn cho hai luật khác nhau (BR-164 là của M99.15). Guard tài liệu sẽ
cảnh báo khoảng trống cho tới khi nhánh kia merge — đó là cảnh báo đúng, và
câu này là câu trả lời cho nó.
