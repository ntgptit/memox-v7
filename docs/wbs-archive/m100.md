...
- **Out of scope:** toàn bộ nhóm D của delta matrix
  (`.superpowers/sdd/2026-09-18-memox-v3-theme-binding/delta-matrix.md`):
...
- **Acceptance criteria:**
  ...
  - [ ] Golden Linux dựng lại cho modal-overlay theo scrim 0.45 mới (Dialog,
        BottomSheet), gallery republish tại URL ghim — controller làm khi
        merge nhánh trên Linux; box này cố ý chưa tick.
