...
| **Updated by task** | M99.23 (AD-21 · mô hình tombstone/batch của Trash) |
...
## AD-21 · Trash: tombstone một cột trên hàng, batch là bảng riêng, loại trừ là hợp đồng của query

| | |
|---|---|
| **Status** | accepted |
| **Affected documents** | `business-rules.md` (BR-182…BR-193), `use-cases.md` (UC-12), `data-model.md` (`delete_batches`, `decks.delete_batch_id`, `cards.delete_batch_id`, bất biến 31…35, schema v8), `wireframes/m99-23-trash-restore.md` |
...
`cards.id` bằng FK, nên phải nhân bản bốn quan hệ rồi ghép lại; BR-188 đòi giữ
