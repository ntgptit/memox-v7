...
| **Updated by task** | M99.23 (AD-19 · rule placeholder gắn với tình trạng branch; Progress đã tốt nghiệp) |
...
|---|---|
| **Status** | accepted |
| **Affected documents** | `product.md` · `it-scenarios/01-navigation-and-continuity.md` · `wbs.md` (M99.7, M99.23) |
...
Progress và Settings; **Progress đã tốt nghiệp ở M99.23** (BR-182…BR-189,
UC-12) và từ đó là một vertical slice đọc dữ liệu thật, nên placeholder rule
không còn áp cho nó. Settings vẫn là scaffold. Mỗi branch có path thật
