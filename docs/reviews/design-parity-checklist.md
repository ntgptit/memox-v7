...
| D27 | `card_detail_screen.dart`, `card_detail_content_widget.dart`, `card_detail_state_widget.dart`, `card_history_section_widget.dart` | `progress_*_widget.dart`, `settings_*_section_widget.dart`, `study_home_body_section_widget.dart` | [x] | **divergence** — M99.31, phân kỳ có chủ đích (quyết định chủ dự án 2026-08-16): ba band của màn chi tiết card đặt **thẳng trên nền scaffold**, không bọc `MxCard`, khác D20 vốn cho mọi section trong cột cuộn một ranh giới hairline. Lý do: D20 giải quyết một cột **danh sách các mục** — mỗi card là một thứ tách biệt để quét và để chạm; màn này là **một trang đọc về đúng một thẻ**, và chia nó thành ba hộp sẽ nói rằng ba band là ba đối tượng chứ không phải ba phần của cùng một câu chuyện. Wireframe M4.15 phân biệt "mặt đọc" với "mặt quản lý" đúng ở chỗ đó. **Ghi ở đây để lần sau không ai "sửa" nó thành card vì tưởng là seam** — cùng lý do D26 tồn tại. Nợ chung: nếu sau này có màn đọc thứ hai, nó phải theo hàng này chứ không theo D20 |
