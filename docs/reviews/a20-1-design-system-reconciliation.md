...
| 19 | Text restyle has one spelling, enforced across features **and** shared, **including aliases** | ❌ 24 sites (9 feature + 15 shared; 23 pattern-matchable + 1 local alias) |
