...
| **Updated by task** | M99.23 (Settings v1 — global study defaults, theme và ngôn ngữ) |
...
### M99.23 · Settings v1 — global study defaults, theme và ngôn ngữ
...
- **Scope:** BR-182…BR-189, UC-12, AD-19, `docs/data-model.md`
...
- **5Why:** Settings là placeholder vì AD-19 dựng IA trước nghiệp vụ; nghiệp vụ
  ...
  (BR-182).
- **Output:**
  - **Phase 1 (docs):** BR-182…BR-189 trong mục mới `Tùy chọn ứng dụng`, ba
    hàng validation, tám hàng edge case; UC-12 đủ chín mục; `app_settings` trong
...
- **Acceptance criteria:**
  ...
  - [x] Đổi mặc định không chạm phiên đang chạy (BR-185 đã có test từ M5 và vẫn
        xanh).
