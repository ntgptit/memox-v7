...
### M4.10j · Giành lại phần Material đang tự quyết (refactor tầng common, đợt 1)
...
**Next task: M4.10k (nâng shared widget, chờ duyệt) rồi M4.11.**

### M4.10k · Nâng shared widget (refactor tầng common, đợt 2)
...
**Next task: M4.10l (AD cho design system) rồi M4.11.**

### M4.10l · AD-14: chốt hệ màu và chiều sâu thành tài liệu
