...
| **Updated by task** | M99.23 (Global Library Search v1) |
...
### M99.23 · Global Library Search v1 — deck, hai mặt card và tag trong một danh sách
...
- **Status:** **in review** — code, docs và host gate xong; PR mở, **chờ**
  ...
  có ghi lý do tại chỗ); (P3) BR-189 nêu đích danh đổi tên tag, mà
...
- **Editable documents:** `docs/business-rules.md`, `docs/use-cases.md`,
  `docs/wbs.md`, `docs/wireframes/m99-23-global-library-search.md`
...
- **Acceptance criteria:**
  - [x] Tìm đúng bốn trường (tên deck, front, back, tên tag) và không tìm
        `example`/`hint`/`pronunciation`, scheduler hay history (BR-182).
  - [x] Truy vấn rỗng **không** sinh statement nào — đo bằng `QueryLogInterceptor`,
        không suy ra từ kết quả (BR-184).
