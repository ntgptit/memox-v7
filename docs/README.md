...
| [`business-rules.md`](business-rules.md) | BR-01…94: cây deck, hai scheduler, review_kind, session lifecycle, reset/generation, starter template, trạng thái thẻ, cờ và tag | **frozen for MVP** |
