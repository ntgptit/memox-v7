...
| **Updated by task** | M99.23 — UC-12: xem tiến độ theo deck (cấp thư viện → cấp deck, hai khoảng) |
...
| ~~Thống kê (S2)~~ | **Đã đặc tả một phần ở M99.23** — UC-12 và BR-182…BR-189 chốt drill-down hoạt động theo deck trên hai khoảng. Còn ngoài phạm vi: accuracy, điểm số, streak dài nhất, dự báo due và so sánh giữa hai khoảng (BR-182) |
