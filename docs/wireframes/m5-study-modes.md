...
## 9. Chiều hỏi của `self_assess` — sheet chọn và thẻ đảo (BR-182…BR-188)
...
│                                              │
│  ◉  Korean first                             │
│     See the Korean, recall what it means.    │
│     — Recommended                            │
│  ○  Meaning first                            │
...
(BR-186), nên một cú chạm nhầm không được phép tiêu mất một phiên. Trong lúc mở
...
`SingleChildScrollView` + `SafeArea(top: false)`. **Sheet chọn mode của BR-146
...
định từ lúc hàng đợi được ghi (BR-184) — nó không "đổi" trong lúc người dùng nhìn,
