...
/// `CardDetailScreen` mounted whole, its one contract faked (UC-12).
///
/// The scenarios are the faces of M4.14 W3 that a person should look at rather
...
final class _CatalogDetailRepository implements CardDetailRepository {
  ...
  CardHistoryEventModel _event({required int index, required bool isSecond}) {
    ...
    // generation heading that BR-186 asks to be readable without colour.
