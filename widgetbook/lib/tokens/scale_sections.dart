  ...
  Widget build(BuildContext context) {
    return const ShowcaseSectionWidget(
      ...
      children: <Widget>[
        ...
        _SpacingBar(name: 'card', value: AppSpacing.card),
        _SpacingBar(name: 'xl', value: AppSpacing.xl),
        _SpacingBar(name: 'xxl', value: AppSpacing.xxl),
        _SpacingBar(name: 'xxxl', value: AppSpacing.xxxl),
        _TouchTargetDemo(),
      ],
    );
  }
    ...
    return const ShowcaseSectionWidget(
      ...
      children: <Widget>[
        Wrap(
          ...
          children: <Widget>[
            _RadiusBox(name: 'xs', value: AppRadius.xs),
            _RadiusBox(name: 'sm', value: AppRadius.sm),
            _RadiusBox(name: 'md', value: AppRadius.md),
            _RadiusBox(name: 'lg', value: AppRadius.lg),
            _RadiusBox(name: 'card', value: AppRadius.card),
            _RadiusBox(name: 'xl', value: AppRadius.xl),
            _RadiusBox(name: 'xxl', value: AppRadius.xxl),
            _RadiusBox(name: 'full', value: AppRadius.full),
          ],
        ),
      ],
    );
    ...
    return const ShowcaseSectionWidget(
      ...
      children: <Widget>[
        Wrap(
          ...
          children: <Widget>[
            _IconSizeDemo(name: 'xs', value: AppIconSize.xs),
            ...
            _IconSizeDemo(name: 'xl', value: AppIconSize.xl),
          ],
        ),
      ],
    );
