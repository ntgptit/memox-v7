...
BAD = {
 ...
 23:"INSERT INTO study_answers VALUES('h23','c1','s1','eight_box',1,'scheduled','match','forgotten','t',NULL,1,0,NULL,1,1,NULL,NULL,NULL,NULL);",
 ...
 31:"INSERT INTO delete_batches VALUES('bt1','deck','b','t2',NULL);"
    "UPDATE decks SET delete_batch_id='bt1' WHERE id='b';",
 32:"INSERT INTO delete_batches VALUES('bt2','deck','a','t2',NULL);"
    "UPDATE decks SET delete_batch_id='bt2' WHERE id='a';",
 33:"INSERT INTO delete_batches VALUES('bt3','deck','r','t2',NULL);",
 # Ancestor deleted BEFORE its descendant — the ordering BR-191 leans on.
 34:"INSERT INTO delete_batches VALUES('bt4','deck','a','t1',NULL);"
 ...
 35:"INSERT INTO delete_batches VALUES('bt6','deck','nosuchdeck','t2',NULL);",
 15:"".join(
