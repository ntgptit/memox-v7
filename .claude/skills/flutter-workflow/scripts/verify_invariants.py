...
CREATE TABLE decks (id TEXT PRIMARY KEY, name TEXT NOT NULL,
 ...
 scheduler_generation INTEGER NULL, first_review_at TEXT NULL,
...
CREATE TABLE card_review_states (card_id TEXT PRIMARY KEY REFERENCES cards(id) ON DELETE CASCADE,
 scheduler_type TEXT NOT NULL, scheduler_version INTEGER NOT NULL, scheduler_generation INTEGER NOT NULL,
 due_at TEXT NULL, last_reviewed_at TEXT NULL, review_count INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE review_history (id TEXT PRIMARY KEY, card_id TEXT NOT NULL REFERENCES cards(id) ON DELETE CASCADE,
 session_id TEXT NOT NULL REFERENCES study_sessions(id), scheduler_type TEXT NOT NULL,
 scheduler_generation INTEGER NOT NULL, review_kind TEXT NOT NULL, action TEXT NOT NULL,
 reviewed_at TEXT NOT NULL, next_due_at TEXT NULL, previous_box INTEGER NULL, next_box INTEGER NULL,
...
def good(c):
    ...
    INSERT INTO card_review_states VALUES('c1','eight_box',1,1,NULL,NULL,0,0,1,NULL,NULL,NULL);
    INSERT INTO study_sessions VALUES('s1','r','r',1,'completed',NULL,'t','t');
    INSERT INTO review_history VALUES('h1','c1','s1','eight_box',1,'relearning','forgotten','t',NULL,1,1,NULL,NULL,NULL,NULL);
    """)
...
BAD = {
 ...
 9: "UPDATE card_review_states SET scheduler_generation=99 WHERE card_id='c1';",
