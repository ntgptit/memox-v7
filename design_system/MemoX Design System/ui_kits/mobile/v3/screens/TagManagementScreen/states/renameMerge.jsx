    ...
    <>
      ...
      <Dialog>
        ...
        <div style={{ padding: '12px 20px 4px' }}>
          ...
          <div style={{ height: 'var(--memox-size-input)', padding: '0 12px', background: 'var(--memox-surface-container-lowest)', border: '1px solid var(--memox-streak)', borderRadius: 'var(--memox-radius-md)', display: 'flex', alignItems: 'center', gap: 8, fontSize: 14, fontWeight: 600, color: 'var(--memox-on-surface)', fontVariantNumeric: 'tabular-nums' }}>
            <span>ngữ pháp</span>
            <span style={{ display: 'inline-block', width: 2, height: 18, background: 'var(--memox-primary)', animation: 'memoxBlink 1s infinite' }} />
          </div>
          <div style={{ fontSize: 12, color: 'var(--memox-on-surface-variant)', marginTop: 4, padding: '0 2px', fontVariantNumeric: 'tabular-nums' }}>8 / 50 · names are unique regardless of letter case.</div>
        </div>
          ...
          <div style={{ background: 'color-mix(in srgb, var(--memox-streak) 8%, transparent)', border: '1px solid color-mix(in srgb, var(--memox-streak) 22%, transparent)', borderRadius: 12, padding: '12px 12px' }}>
            <div style={{ display: 'flex', gap: 8, alignItems: 'flex-start', marginBottom: 8 }}>
              ...
              <div style={{ flex: 1, fontSize: 12, lineHeight: 1.5, color: 'var(--memox-on-surface)' }}>
                A tag called <strong style={{ fontWeight: 700 }}>ngữ pháp</strong> already exists. Continuing will <strong style={{ fontWeight: 700 }}>merge</strong> “{selectedTag.name}” into it — its spelling stays “ngữ pháp”.
              </div>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 8px', borderRadius: 'var(--memox-radius-md)', background: 'var(--memox-surface-container-lowest)', flexWrap: 'wrap' }}>
              ...
              <TagPill name="ngữ pháp" count={31 + 46} />
            </div>
            <div style={{ fontSize: 12, color: 'var(--memox-on-surface-variant)', marginTop: 8, lineHeight: 1.5 }}>
              No card is deleted. Cards carrying both keep one tag; no card goes over 10 tags.
            </div>
          </div>
        </div>
