    ...
    <>
      ...
      <Dialog>
        ...
        <div style={{ padding: '12px 20px 4px' }}>
          ...
          <div style={{ height: 'var(--memox-size-input)', padding: '0 12px', background: 'var(--memox-surface-container-lowest)', border: '1px solid var(--memox-primary)', borderRadius: 'var(--memox-radius-md)', display: 'flex', alignItems: 'center', gap: 8, fontSize: 14, fontWeight: 600, color: 'var(--memox-on-surface)', fontVariantNumeric: 'tabular-nums' }}>
            <span>humans</span>
