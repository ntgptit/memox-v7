/* MemoX Mobile v3 — GuessScreenV3  (A18 · guess)
   Product: one term, exactly 5 meanings (BR-121); only the first pick counts;
   wrong cards return in a later round. v1 layout kept; context line corrected.
   ── v1 header ──
  ...
  return (
    <div className="app">
      ...
      <div style={{ padding: '0 16px 20px', marginTop: -4 }}>
        <div className="ov" style={{ textAlign: 'center' }}>Nhà hàng · Review · Guess · round 1 · first pick counts</div>
      </div>
...
Object.assign(window, { GuessScreenV3 });
})();
