  ...
  return (
    <div className="app">
      ...
      <div style={{ padding: '0 16px 20px', marginTop: -4 }}>
        <div className="ov" style={{ textAlign: 'center' }}>Vocab — chapter 1 · Meaning → term</div>
      </div>
      ...
      <div style={{
        ...
        <Ic name="pencil" size="xs" color="var(--memox-on-surface-variant)" />
        <span>{state === 'wrong' ? 'Compare your answer, then try again' : 'Type the term for this meaning, then check'}</span>
      </div>
