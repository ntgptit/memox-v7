...
function OfflineBanner() {
  return (
    <div role="status" style={{
      ...
      <Ic name="cloud-off" size="xs" color="var(--memox-on-surface-variant)" />
    ...
    <div role="search" onClick={onClick} style={{
      ...
      {filled ?
        ...
        <button className="icon-btn" aria-label="Search by voice" style={{ width: 36, height: 36 }}>
          <Ic name="mic" size="sm" color="var(--memox-on-surface-variant)" />
        </button>}
    </div>);
...
function ListRow({ icon, seed, leading, title, sub, trailing, last = false, tileSize = 'sm', onClick, style } = {}) {
  ...
  return (
    <div role={onClick ? 'button' : undefined} tabIndex={onClick ? 0 : undefined} onClick={onClick} style={{
      display: 'grid', gridTemplateColumns: 'auto 1fr auto', gap: 12, alignItems: 'center', padding: '12px 16px',
      ...
      <div style={{ minWidth: 0 }}>
        ...
        {sub ? <div style={{ fontSize: 12, color: 'var(--memox-on-surface-variant)', marginTop: 1, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{sub}</div> : null}
      </div>
...
function EmptyState({ icon = 'inbox', title, body, action, footnote, compact = false, style } = {}) {
  ...
  return (
    <div className="card" style={{ padding: compact ? '32px 24px' : '44px 24px 32px', textAlign: 'center', marginTop: 8, ...style }}>
      ...
      {footnote ?
        <div style={{
          marginTop: 20, padding: '8px 12px', background: 'var(--memox-surface-container-lowest)',
  ...
  return (
    <div className="card" style={{ padding: '40px 24px', textAlign: 'center', marginTop: 8, ...style }}>
      <div style={{
        ...
        background: 'color-mix(in srgb, var(--memox-danger) 10%, transparent)', color: 'var(--memox-error)',
        display: 'inline-flex', alignItems: 'center', justifyContent: 'center'
      }}>
  ...
  return (
    <div>
      <div style={{
        ...
        background: 'var(--memox-surface-container-lowest)', border, borderRadius: 'var(--memox-radius-input)',
        opacity: disabled ? 'var(--memox-op-disabled)' : 1,
...
Object.assign(window, {
  StatusBar, masteryColor, Ic, ICON, Breadcrumb, BottomNav, OfflineBanner, SearchField, Badge, StudyTopBar,
