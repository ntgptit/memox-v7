...
/// instant.** The fire *occurrence* is chosen from `notBefore` — BR-221 pushes
...
void main() {
  ...
  test('a notBefore already behind us falls back to the ordinary next '
    ...
    // to break BR-221. Clamping the anchor gives the ordinary answer.
  ...
  test('the work is replaced, never stacked (BR-227)', () async {
    await repository.schedule(
      time: eightPm,
      now: DateTime.utc(2026, 7, 29, 3),
      utcOffset: offset,
