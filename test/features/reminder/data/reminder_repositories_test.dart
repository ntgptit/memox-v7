...
/// production schema.
///
/// **Not a mocked DAO.** BR-224's "counted exactly once" is a property of a
...
void main() {
  ...
  group('workload (BR-220, BR-224)', () {
    ...
    test('unlearned cards never appear (BR-220)', () async {
    ...
    test('a card is counted once, under its root (BR-224)', () async {
    ...
    test('reading the workload writes nothing (BR-225)', () async {
      final fixture = await deckWithCards(db, cardCount: 2);
