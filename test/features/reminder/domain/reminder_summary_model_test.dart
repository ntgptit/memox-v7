...
/// BR-220's skip, BR-222's content limit, BR-223's ordering and BR-224's count,
...
void main() {
  group('build', () {
    test('nothing owed produces no summary at all (BR-220)', () {
    ...
    test('the total is the sum of every deck, counted once (BR-224)', () {
