...
void main() {
  ...
  group('deliver (BR-220, BR-221, BR-222)', () {
    ...
    test('an empty workload at fire time posts nothing (BR-220)', () async {
      final outcome = await deliver()(now: now, utcOffset: offset);
    ...
    test(
      'a day that has already had its summary posts nothing (BR-221)',
      () async {
    ...
    test('a delivery on an earlier local day blocks nothing', () async {
      ...
      // pushed past midnight. That serves the 30th, and BR-221 asks for at most
