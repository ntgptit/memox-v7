...
/// The value object that makes BR-219's range unskippable, and the one piece of
...
void main() {
  group('parse', () {
    ...
    test('the suggested default is 20:00 (BR-219)', () {
  ...
  group('nextOccurrenceAfter', () {
    ...
    test(
      ...
      () {
        // The whole reason BR-219 stores a local minute rather than a UTC one: a
