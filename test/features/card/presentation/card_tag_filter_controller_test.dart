...
/// The tag filter as an input-state notifier (BR-183, BR-184).
///
...
void main() {
  ...
  test('starts with no tag predicate at all (BR-183)', () {
  ...
  test('applying a selection resets the window (BR-184)', () {
    final container = containerWith(FakeCardRepository());
  ...
  test('a change to the tag filter clears the selection (BR-184)', () {
    final container = containerWith(FakeCardRepository());
