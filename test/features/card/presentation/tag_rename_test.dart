...
/// The rename sheet, including the merge disclosure (UC-12, BR-185, BR-186,
/// wireframe M4.14 W4).
void main() {
  ...
  testWidgets('a free name submits as a rename (BR-185)', (tester) async {
  ...
  group('the merge disclosure appears before confirming (BR-186)', () {
    ...
    testWidgets('changing only the case is not a merge (BR-185)', (
      tester,
    ) async {
      await openRename(tester, FakeTagCatalogRepository.seeded(tags));
