...
void main() {
  const tags = <TagCatalogEntry>[
    ...
    TagCatalogEntry(id: 't3', name: 'TOPIK II', cardCount: 0, linkedCardCount: 0),
  ];
  ...
  testWidgets('face 2 — every tag with its count, and no create action', (
    ...
    // BR-230: a tag no card carries stays, and says so in words.
  ...
  testWidgets('the search term reaches the read, not a Dart filter', (
    ...
    // BR-230: the fold and the counts belong to the statement. A screen that
