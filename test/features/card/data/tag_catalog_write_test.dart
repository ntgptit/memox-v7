...
/// The tag catalog's **writes** on a real SQLite database (UC-18,
/// BR-233…BR-236).
///
...
void main() {
  ...
  group('rename without a collision keeps the tag (BR-233)', () {
  ...
  group('rename onto an existing name merges (BR-234)', () {
  ...
  group('delete unlinks and deletes nothing else (BR-235, BR-236)', () {
  ...
  group('rollback leaves the original graph (BR-234, BR-235)', () {
    ...
    /// precisely the half-merged state BR-234 forbids, and the only way to
