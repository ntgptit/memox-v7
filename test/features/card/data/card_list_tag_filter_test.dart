...
/// The multi-tag filter on a real SQLite database (BR-231, BR-232).
///
...
void main() {
  ...
  group('no tag selected is the identity (BR-231)', () {
  ...
  group('OR within the selected tags (BR-231)', () {
    ...
    test(
      ...
      () async {
        ...
        // The stale-id case BR-234/BR-235 leave behind: it narrows to nothing
  ...
  group('AND with the state filter and the search term (BR-231)', () {
  ...
  group('the window is a window of cards (BR-231)', () {
  ...
  group('select all uses the same predicate (BR-167, BR-231)', () {
