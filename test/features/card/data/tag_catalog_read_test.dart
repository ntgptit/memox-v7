...
/// The tag catalog's **read** on a real SQLite database (UC-12, BR-182).
///
...
void main() {
  ...
  group('the catalog read (BR-182)', () {
    ...
    test('keeps a tag no card carries, at zero (BR-182)', () async {
      final deck = await seedDeck();
  ...
  group('tags from other paths are ordinary catalog rows (BR-190)', () {
