...
/// [TagFilter]'s algebra (BR-231, BR-232).
///
/// The rule this type exists to hold is BR-231's identity clause — "no tag
...
void main() {
  group('the empty selection is the identity (BR-231)', () {
  ...
  group('retaining drops tags that no longer exist (BR-234, BR-235)', () {
