...
/// The three catalog use cases (UC-18).
///
...
/// the moment of the write (BR-234).
void main() {
  ...
  group('WatchTagCatalogUseCase', () {
    test('passes the search term through to the statement (BR-230)', () {
  ...
  group('RenameTagUseCase applies BR-93 before the repository', () {
    ...
    test('reports what the write turned out to be (BR-234)', () async {
    ...
    test(
      ...
      () async {
        ...
        // transaction and make it a race (BR-234).
        expect(
          await RenameTagUseCase(repository)(tagId: 't1', rawName: 'noun'),
