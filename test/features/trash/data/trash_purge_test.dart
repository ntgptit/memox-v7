...
/// Retention and purge (BR-264, BR-265), against real SQLite.
void main() {
  final h = installTrashHarness();

  group('the thirty-day boundary (BR-264)', () {
  ...
  group('what a purge takes with it (BR-265)', () {
    ...
    test('a batch whose cascade would reach another is refused', () async {
      // The precondition BR-265 exists for: purging the deck would cascade
