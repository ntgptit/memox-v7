...
/// The Trash screen's state matrix (UC-12 UI states).
void main() {
  ...
  group('the list', () {
    ...
    testWidgets('the sweep runs before the first emission (BR-190)', (
      tester,
    ) async {
      // Opening Trash is one of BR-190's three triggers, and it lives in the
    ...
    testWidgets('the origin path reads as context, not as a destination', (
      ...
      // One line, prefixed and with no tap target of its own (BR-193, T5).
      expect(
  ...
  group('restore', () {
    testWidgets('the picker asks, and the answer reaches the repository', (
      ...
      // (BR-188), even though the origin is preselected.
