...
/// The two appearance choices and the value that carries them (BR-214, BR-215).
void main() {
  group('AppThemeMode', () {
  ...
  group('AppLanguage', () {
    ...
    test('system carries no language code, the other two carry theirs', () {
      ...
      // "resolve from the platform", which is exactly BR-215's `system`.
  ...
  group('AppSettingsModel.defaults', () {
    test('the card limit is Study\'s constant, not a second copy', () {
      // BR-211: one copy of the number. If someone retypes 20 here and BR-24
