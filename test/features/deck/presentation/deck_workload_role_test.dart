...
void main() {
  ...
  test('the pairs this mapping leans on clear WCAG', () {
    ...
    final pairs = <String, (Color, Color)>{
      ...
      // surface in the streak ink. Measured 12.62:1 light / 9.82:1 dark on
      // the v3 palette (2026-09-17); this holds the pair to the body-text
      // floor.
      ...
      //
      // The pair is `dangerInk`, not `danger` — `AppInk.danger`/`.overdue`
      // resolve to `dangerInk` (GC-3), and the plain fill is the wrong side
      // of that alias here: `dangerLight` on `paperLight` reads 4.21:1 on
      // the v3 palette, under the floor this test exists to hold. That is
      // exactly the case `dangerInk` was measured for.
