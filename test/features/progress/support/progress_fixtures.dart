...
/// The instant the **level** fixtures are built at.
///
/// A different name from the overview harness's `progressTestNow`, and a
/// different instant: the two features fixed their own clocks and both were
/// re-exported into the same tests by the merge. Renaming rather than
/// reconciling, because the values are not interchangeable — the level fixtures
/// are built at +07:00 and the overview's at zero offset.
final DateTime progressLevelTestNow = DateTime.utc(2026, 8, 13, 9);

/// The next local midnight after [progressLevelTestNow] at the harness's +07:00 —
