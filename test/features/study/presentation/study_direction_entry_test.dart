// Which decks are asked for a direction on the way into a review (BR-203).
//
...
///
/// That is the only way to reach UC-15 E2 through the real screen: with nothing
...
void main() {
  ...
  testWidgets('an eight_box deck is never offered one (BR-203)', (
    tester,
  ) async {
  ...
  testWidgets('the last card going while the sheet is open is said in it', (
    ...
    // UC-15 E2. Before this, the sheet popped first and BR-145's refusal
  ...
  testWidgets('the deck changing algorithm under the sheet is said in it', (
    ...
    // UC-15 E1, through the real screen. The unit tests prove the use case
