...
/// The card when the recall direction is reversed (BR-183).
///
...
void main() {
  ...
  group('the card asks the way the row says (BR-183)', () {
    ...
    testWidgets('a row with no direction draws what it always drew', (
      ...
      // Every session outside BR-182 — the learning chain, `browse`, every
