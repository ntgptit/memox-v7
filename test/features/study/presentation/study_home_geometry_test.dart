...
/// (UC-14, wireframe `m5-study-home.md` G1…G5b, G11, G12).
///
...
void main() {
  ...
  group('gutters and shared edges', () {
    ...
    testWidgets('at 320dp the gutter is still the screen gutter', (
      tester,
    ) async {
      ...
      // `mxScreenGutter` is 16 at every width since M100.89, and the screen
