...
/// What Study Home counts, and how it ranks what it counted (UC-14, BR-201).
///
...
void main() {
  ...
  group('workload', () {
    ...
    test('a root with no cards is listed, with zeroes', () async {
      ...
      // indistinguishable from "no decks", and those are two screens (BR-202).
      await insertRootDeck(db, id: 'root');
  ...
  group('expiry', () {
    ...
    test('an open session arms the midnight tick even with nothing due', () async {
      // BR-200 offers a session back only while it belongs to the current study
