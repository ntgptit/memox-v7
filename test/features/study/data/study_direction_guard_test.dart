...
void main() {
  ...
  group('eight_box cannot reach any of it (BR-203)', () {
    ...
    test('a graded stage handed one is refused outright', () async {
      ...
      // prevent it. The use case refuses this first (BR-208); the two guards
  ...
  group('the schedule is untouched (BR-209)', () {
  ...
  test('card content is never rewritten (BR-209)', () async {
