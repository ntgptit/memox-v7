...
/// Which sessions may carry a recall direction, and which are refused (BR-187).
///
...
void main() {
  ...
  group('everything else is refused a direction (BR-182)', () {
  ...
  test('resume asks nothing and is given nothing (BR-186)', () async {
