...
class CardReviewStates extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  CardReviewStates(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> cardId = GeneratedColumn<String>(
    'card_id',
    aliasedName,
    false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'card_review_states';
  @override
  ...
  @override
  CardReviewStates createAlias(String alias) {
    return CardReviewStates(attachedDatabase, alias);
  }
...
class ReviewHistory extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ReviewHistory(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> reviewKind = GeneratedColumn<String>(
    ...
    requiredDuringInsert: true,
    $customConstraints:
        'NOT NULL CHECK (review_kind IN (\'scheduled\', \'relearning\'))',
  );
  ...
  @override
  ReviewHistory createAlias(String alias) {
    return ReviewHistory(attachedDatabase, alias);
  }
...
class DatabaseAtV3 extends GeneratedDatabase {
  ...
  late final ReviewHistory reviewHistory = ReviewHistory(this);
  late final Index idxHistoryCard = Index(
    'idx_history_card',
    'CREATE INDEX idx_history_card ON review_history (card_id, reviewed_at)',
  );
  ...
  late final Index idxReviewStatesDue = Index(
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules([
    ...
    WritePropagation(
      ...
      result: [TableUpdate('card_review_states', kind: UpdateKind.delete)],
    ),
    WritePropagation(
      on: TableUpdateQuery.onTableName(
        'decks',
