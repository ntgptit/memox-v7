...
class StudySessions extends Table with TableInfo {
  ...
  late final GeneratedColumn<String> endReason = GeneratedColumn<String>(
    ...
    requiredDuringInsert: false,
    $customConstraints:
        'NULL CHECK (end_reason IS NULL OR end_reason IN (\'user_exit\', \'scheduler_reset\', \'stale_generation\', \'persistence_error\'))',
  );
...
class StudyAnswers extends Table with TableInfo {
  ...
  late final GeneratedColumn<String> kind = GeneratedColumn<String>(
    ...
    requiredDuringInsert: true,
    $customConstraints:
        'NOT NULL CHECK (kind IN (\'scheduled\', \'relearning\'))',
  );
