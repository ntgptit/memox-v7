...
class StudySessions extends Table with TableInfo {
  ...
  late final GeneratedColumn<String> endReason = GeneratedColumn<String>(
    ...
    requiredDuringInsert: false,
    $customConstraints:
        'NULL CHECK (end_reason IS NULL OR end_reason IN (\'user_exit\', \'scheduler_reset\', \'scheduler_changed\', \'stale_generation\', \'persistence_error\', \'interrupted\', \'content_deleted\', \'subtree_promoted\'))',
  );
