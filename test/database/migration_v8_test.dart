...
void main() {
  ...
  group('v7 → v8 · old rows stay active', () {
  ...
  group('v7 → v8 · the session rebuild', () {
  ...
  test('a v8 database opened again runs no migration', () async {
    // Cheap, and it catches an `if (from < 8)` written as `if (from <= 8)`.
