...
/// The detail route (UC-19, M4.15 W1): its name, its URL, the order it is
...
void main() {
  ...
  group('the bare :cardId segment is registered last (M4.15 W1)', () {
  ...
  group('coming back (BR-246)', () {
    ...
    testWidgets('Edit pushes the editor on top, so leaving it returns to the '
        'card being read (UC-19 A1)', (tester) async {
