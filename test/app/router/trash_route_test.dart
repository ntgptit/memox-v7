...
/// Trash's route (UC-12, AD-21), through the real route table.
///
/// **Two facts, and the second is the one AD-21 decided.** That the route
...
void main() {
  ...
  testWidgets('Trash keeps the bottom bar, so it is inside the branch', (
    ...
    // The whole of AD-21's navigation decision, as one assertion: a route
