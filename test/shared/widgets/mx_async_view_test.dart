...
void main() {
  ...
  group('the loading policy', () {
    ...
    ///
    /// Both directions are asserted because the default is the load-bearing
    /// half: `shouldSkipLoadingOnReload` is `false` so that a screen whose
    /// dependency changed does not keep showing the previous dependency's
    /// answer, and flipping that default would have made no test in the
    /// repository fail.
