...
void main() {
  for (final (String mode, ThemeData Function() build)
    ...
    group('$mode · component slot resolves its canonical M3 role', () {
      ...
      // **The one departure, stated in this diff** (GC-3, 2026-09-17). v3's
      // light `primary` fails 4.5:1 as a label on the page, so the brand *as
      // text* — TextButton, OutlinedButton, the selected tab — is
